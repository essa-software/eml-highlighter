...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(RegisterClasses, Keywords, Properties, Values, ColorThemeElements);
	context.subscriptions.push(ini.BgFgTextColorTheme, ini.TextBoxColorTheme, ini.SelectionColorTheme, ini.HoverableWidgetColorTheme, ini.ButtonColorTheme);
}
